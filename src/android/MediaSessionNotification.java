...
public class MediaSessionNotification {
  ...
  private void createBuilder() {
    ...
    if (infos.rating) {
      nbControls++;
      Intent favoriteIntent = new Intent("music-controls-unfavorite");
      PendingIntent favoritePendingIntent = PendingIntent.getBroadcast(context, 1, favoriteIntent, 0);
      builder.addAction(this.getResourceId("media_favorite", android.R.drawable.ic_menu_close_clear_cancel), "", favoritePendingIntent);
    } else {
      nbControls++;
      Intent unfavoriteIntent = new Intent("music-controls-favorite");
      PendingIntent unfavoritePendingIntent = PendingIntent.getBroadcast(context, 1, unfavoriteIntent, 0);
      builder.addAction(this.getResourceId("media_notfavorite", android.R.drawable.ic_menu_close_clear_cancel), "", unfavoritePendingIntent);
    }

    nbControls++;
    Intent shareIntent = new Intent("music-controls-share");
    PendingIntent sharePendingIntent = PendingIntent.getBroadcast(context, 1, shareIntent, 0);
    builder.addAction(this.getResourceId("media_share", android.R.drawable.ic_menu_close_clear_cancel), "", sharePendingIntent);
