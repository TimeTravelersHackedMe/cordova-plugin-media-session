...
public class MusicControls extends CordovaPlugin {
  ...
  private void registerBroadcaster(MusicControlsBroadcastReceiver mMessageReceiver) {
    ...
    context.registerReceiver((BroadcastReceiver) mMessageReceiver, new IntentFilter("music-controls-unfavorite"));
    context.registerReceiver((BroadcastReceiver) mMessageReceiver, new IntentFilter("music-controls-share"));
  ...
  private void setMediaPlaybackState(int state) {
    ...
    if (state == PlaybackStateCompat.STATE_PLAYING) {
      ...
      playbackstateBuilder.setState(state, this.position, 1.0f);
    } else {
      playbackstateBuilder.setActions(PlaybackStateCompat.ACTION_PLAY_PAUSE | PlaybackStateCompat.ACTION_PLAY
          ...
          | PlaybackStateCompat.ACTION_PREPARE | PlaybackStateCompat.ACTION_PREPARE_FROM_SEARCH
          | PlaybackStateCompat.ACTION_SET_RATING | PlaybackStateCompat.ACTION_SEEK_TO);
      playbackstateBuilder.setState(state, this.position, 0);
    }
